...
public class UserControllerTest {
    ...
    @Test
    void tesRegisterSuccess() throws Exception {
    ...
    @Test
    void tesRegisterBadRequest() throws Exception {
        RegisterUserRequest request = new RegisterUserRequest();
        request.setUsername("");
        request.setPassword("");
        request.setName("");
    ...
    @Test
    void tesRegisterDuplicate() throws Exception {
        User user = new User();
    ...
    void testUpdateSuccess() throws Exception {
        ...
        UpdateUserRequest request = new UpdateUserRequest();
        request.setName("Iyan");
        request.setPassword("iyan123");
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals("Iyan", response.getData().getName());
            assertEquals("test", response.getData().getUsername());

            User userDb = userRepository.findById("test").orElse(null);
            assertNotNull(userDb);
            assertTrue(BCrypt.checkpw("iyan123", userDb.getPassword()));
        });
    }
}
